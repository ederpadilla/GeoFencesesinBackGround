...
import ederdev.padilla.backgroundservices.MainActivity;
import ederdev.padilla.backgroundservices.R;
...
public class GeofenceTransitionsIntentService extends IntentService {
    ...
    public void onCreate() {
        super.onCreate();
        Log.e(TAG,"Entra a create service");
    }
    @Override
    protected void onHandleIntent(@Nullable Intent intent) {
        sendNotification("Entra al service");
    ...
    private String getGeofenceTransitionDetails(
        ...
        Log.e(TAG,triggeringGeofencesIdsString);
